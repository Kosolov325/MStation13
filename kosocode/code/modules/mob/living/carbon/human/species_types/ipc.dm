/datum/species/ipc
	...
	blacklisted = 0
	sexes = 0
	inherent_traits = list(TRAIT_EASYDISMEMBER,TRAIT_LIMBATTACHMENT,TRAIT_NO_PROCESS_FOOD, TRAIT_ROBOTIC_ORGANISM,TRAIT_NOBREATH,TRAIT_RADIMMUNE,TRAIT_NOCLONE,TRAIT_TOXINLOVER)
