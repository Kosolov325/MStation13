/obj/item/gun/energy/e_gun/blueshield
	...
	charge_sections = 4
	fire_delay = 4
	icon = 'kosocode/modular_skyrat/icons/obj/guns/energy.dmi'
	icon_state = "bsgun"
	item_state = "minidisable"
	lefthand_file = 'kosocode/modular_skyrat/icons/mob/inhands/weapons/guns_lefthand.dmi'
	righthand_file = 'kosocode/modular_skyrat/icons/mob/inhands/weapons/guns_righthand.dmi'
